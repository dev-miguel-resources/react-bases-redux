...
const Jugadores = ({jugadores, agregarTitular, agregarSuplente}) => { //recibir funcion por propiedades y manejadas por el mapdDistpach
  ...
  // Función que fija el tamaño del grid de los jugadores por medio de un scroll
...
const mapStateToProps = state => ({ //recibe el estado y retorna el objeto
...
const mapDispatchToProps = dispatch => ({
  agregarTitular(jugador) {
    dispatch({
      ...
      jugador //le paso este objeto, el cual por medio del identificador lo puedo pasar al action del store
    })
  },
